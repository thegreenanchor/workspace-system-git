# The Green Anchor Marketing Team (Codex Project Config)

This file is the Codex project instruction source for this workspace.

## Purpose
Support an AI marketing team for The Green Anchor (TGA) creating:
- Blog content
- SEO content
...
## Brand placeholders to define
Set these at the start of workstreams in `strategies/brand-foundation.md`:
- Core offer(s)
- Primary audience segments
- Positioning statement
- Tone nuances and banned words
- Core proof points and differentiators
